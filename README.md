...
Константы проекта хранятся в файле 'settings.py'.

1. 'MAX_LEN_POST' — лимит постов на странице (по умолчанию 5)  
2. 'MAX_STR_LEN' — максимальная длина отображаемой строки в методах '__str__' (по умолчанию 15)  
3. 'MAX_TITLE_LEN' — максимальная длина заголовка для моделей (по умолчанию 256)
